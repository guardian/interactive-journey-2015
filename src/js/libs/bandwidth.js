define([], function() {
	var smallFile = 'https://cdn.theguardian.tv/interactive/speedtest/testfilesmall.dat';
	var largeFile =  'https://cdn.theguardian.tv/interactive/speedtest/testfile.dat';
	...
	function getSpeed(callback) {
		var startTime = new Date().getTime();
		var checkFileSmall = 'https://cdn.theguardian.tv/interactive/speedtest/testfilesmall.dat';
		var fileSizeSmall = 1024*8;
		var checkFileLarge = 'https://cdn.theguardian.tv/interactive/speedtest/testfile.dat';
